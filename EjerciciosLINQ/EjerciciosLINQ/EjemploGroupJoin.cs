...
{
    internal class EjemploGroupJoin : Confiable
    {
        public override void otroMas()
        {
            ...
            // sintaxis queries
            var empresasYSusEmpleados2 = (from empresa in empresas join persona in personas on empresa.Id equals persona.EmpresaId into personas2 select new { Empresa = empresa, Personas = personas2 });
