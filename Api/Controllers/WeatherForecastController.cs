...
namespace Api.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        {
            HttpContext.Response.Headers.Append("ejemplo-respuesta", "El valor");
            //return BadRequest();
        ...
        [HttpGet("mayusculas")]
        public ActionResult<string> GetMayusculas([FromHeader]string valorPersonalizado = "Soy Arturo")
        {
